...
raw_data1 <- read.xlsx('~/Desktop/使用教程和资料/输入模板示例/克隆形成报告范例.xlsx',sheet=1,startRow = 1)
raw_data2 <- read.xlsx('~/Desktop/使用教程和资料/输入模板示例/克隆形成报告范例.xlsx',sheet=2,startRow = 3)
