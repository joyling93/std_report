...
server <- function(input, output) {
  output$uip <- renderUI({
    ...
    switch(input$input_type,
           ...
           "gene_kd_oe" = tags$a(href = "https://www.teambition.com/project/58081fe94863251f4269aaf3/works/5ed0641b21c5cf0021786f8f/work/5ed06429ab2cbf0021d5d93c",
                                 "点此链接下载Excel模板", target = "_blank"),
           'vector_virus'= tags$a(href = "https://www.teambition.com/project/58081fe94863251f4269aaf3/works/5ed0641b21c5cf0021786f8f/work/5f4ca834b68f2a0044ec8618",
                                  "点此链接下载Excel模板", target = "_blank"),
  ...
  output$ui <- renderUI({
    ...
    switch(input$input_type,
           ...
           'vector_virus'= fileInput("file2", "上传 载体图谱、靶序列测序结果 或 酶切鉴定结果 图片",
                                     multiple = TRUE,
